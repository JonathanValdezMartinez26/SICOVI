...
function loadSearchData() {
    const searchJson = $("#layout-menu").hasClass("menu-horizontal")
                                        ...
                                        <div class="suggestion-items">
                                            ${items.map(
                                                (item) => html`
                                                    ...
                                                    >
                                                        <i
                                                            class="icon-base bx ${item.icon} me-2"
                                                        ></i>
                                                        <span>${item.name}</span>
                                                    </a>
                                                `
                        ...
                        <div class="search-no-results-wrapper">
                            <div class="d-flex justify-content-center align-items-center h-100">
                                <div class="text-center text-heading">
                                    <i
                                        class="icon-base bx bx-file text-body-secondary icon-48px mb-4"
                                    ></i>
                                ...
                                return html`
                                    ...
                                    >
                                        <span class="item-wrapper"
                                            ><i class="icon-base bx ${item.icon}"></i
                                            >${item.name}</span
                                        >
                                        <svg
                                        ...
                                        >
                                            <path
                                                fill="currentColor"
                                                d="M16 13h-6v-3l-5 4l5 4v-3h7a1 1 0 0 0 1-1V5h-2z"
                                            />
                                        </svg>
                                    </a>
                                `
                        ...
                        templates: {
                            ...
                            item({ item, html }) {
                                return html`
                                    <a
                                        href="${item.url}"
                                        class="d-flex align-items-center py-2 px-4"
                                    >
