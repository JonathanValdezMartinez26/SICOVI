                        ...
                        <div class="tab-content" id="v-pills-tabContent">
                            ...
                            <div class="tab-pane fade show active" id="content-personales" role="tabpanel" aria-labelledby="tab-personales">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-3">
                                        <div class="col-3"><label class="form-label"><strong>Infonavit:</strong></label></div>
                                        <div class="col-9">
                                            <input class="form-check-input" type="checkbox" id="detalleInfonavit" disabled>
                                        </div>
                                    </div>
                                </div>
                                <div class="row mb-3">
                            ...
                            <div class="tab-pane fade" id="content-nomina" role="tabpanel" aria-labelledby="tab-nomina">
                                ...
                                <div class="row mb-3">
                                    <div class="col-4"><label class="form-label"><strong>Proveedor:</strong></label></div>
                                    <div class="col-8">
                                        <input type="text" id="detalleProveedor" class="form-control" disabled>
                                    </div>
                                </div>
                                <div class="row mb-3">
